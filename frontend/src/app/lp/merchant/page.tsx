  ...
  return (
    <div className="w-full">
        ...
        >
          <div className="text-center max-w-4xl px-[39px] md:px-0 -mt-[200px] md:mt-0 relative md:z-30">
            ...
            <div className="mb-6 md:mb-10">
              ...
              >
                nomocaKagawa掲載店<br className="md:hidden" />
                募集中
              </h2>
            </div>
        ...
        <div className="px-[39px] md:px-8 lg:px-16 xl:px-52">
          ...
          >
            ...
            >
              ...
              >
                「nomocaKagawa」を運営する株式会社つなぐは、高松市が出資する地域商社です。
              </p>
              <p
                className="text-base md:text-lg"
                style={{
              ...
              >
                地元に根ざした運営だからこそ、お店の皆さまも安心して「nomocaKagawa」にご参加いただけます。
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="benefits" className="w-full py-12 md:py-16 lg:py-24" style={{ backgroundColor: '#F5F5F5' }}>
        <div className="max-w-6xl mx-auto px-[39px] md:px-[120px]">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            >
              &quot;nomocaKagawa&quot;に掲載することで、新しいお客様との出会いが広がります！
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-2 md:gap-3">
                ...
                >
                  「nomocaKagawa」をきっかけに来店したお客様が、料理や追加注文をすることで客単価がアップ。回遊性も高まり、新規顧客獲得につながります。
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-2 md:gap-3">
                ...
                >
                  掲載店ステッカーを貼るだけで導入完了。nomocaKagawaスタッフが運用までしっかりサポートします。
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          「nomocaKagawa」のご利用を開始するまでのステップをご紹介します。
        </p>
        ...
        >
          ...
          >
            ...
            >
              申し込み内容をnomocaKagawa事務局で確認し、販促物を店舗に向けて発送します。
            </p>
          </div>
