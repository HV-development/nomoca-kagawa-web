            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#2B7A78] focus:border-[#2B7A78] ${
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <input
                    ...
                    className="mt-1 h-4 w-4 flex-shrink-0 text-[#2B7A78] focus:ring-[#2B7A78] border-gray-300 rounded cursor-pointer"
                  />
                  <label htmlFor="agreedToRegistration" className="ml-2 text-sm text-gray-700 cursor-pointer">
                    nomocaKagawa加盟店としてサービスを開始するため、申込み後に店舗情報及びクーポン情報の登録が必要であることを確認しました。
                  </label>
                </div>
