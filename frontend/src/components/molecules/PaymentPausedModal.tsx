...
interface PaymentPausedModalProps {
  isOpen: boolean
  onUpdatePayment: () => void
  onClose: () => void
}

export function PaymentPausedModal({ isOpen, onUpdatePayment, onClose }: PaymentPausedModalProps) {
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-gray-900">お支払いが確認できません</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <p className="text-gray-700 mb-6 leading-relaxed">
            継続課金のお支払いが確認できないため、現在クーポンをご利用いただけません。お支払い方法をご確認のうえ、更新してください。
          </p>
