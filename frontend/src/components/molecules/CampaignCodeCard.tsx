    ...
    <div className="w-full rounded-2xl border border-[#d9d9d9] bg-white p-6 space-y-4">
      <div className="space-y-3">
        ...
        <div className="flex items-end gap-1">
          <p className="text-[24px] font-semibold leading-none text-[#3A8A88]">￥0</p>
        ...
        <div className="flex items-start gap-2">
          <div className="flex-1 min-w-0 space-y-1.5">
            <div
              className={`relative flex h-10 items-center rounded-[10px] border px-3 ${
                isApplied ? "border-[#3A8A88] bg-white" : "border-[#d9d9d9] bg-white"
              }`}
            >
              <input
                type="text"
              ...
              />
              {isApplied && (
                <Check className="h-4 w-4 flex-shrink-0 text-[#3A8A88]" strokeWidth={3} />
              )}
            </div>
            {errorMessage && (
          ...
          {isApplied ? (
            <button
              type="button"
              disabled
              className="shrink-0 cursor-not-allowed rounded-lg border border-[#3A8A88] bg-[#FFFEF5] px-2 py-3 text-sm font-semibold text-[#3A8A88]"
            >
              適用済み
            </button>
          ) : (
            <button
              ...
              onClick={handleApply}
              disabled={isApplying}
              className="shrink-0 rounded-lg bg-[#3A8A88] px-2 py-3 text-sm font-semibold text-white disabled:opacity-60"
            >
              {isApplying ? "確認中..." : "適用する"}
            </button>
          )}
      ...
      {isApplied && (
        <div className="flex items-center justify-center gap-2 rounded-lg border border-[rgba(58,138,136,0.24)] bg-[#FFFEF5] p-2.5">
          <Check className="h-4 w-4 text-[#3A8A88]" strokeWidth={3} />
          <p className="text-xs font-bold text-[#2B7A78]">
