...
export function AreaButton({ label, isSelected, onClick, className = "" }: AreaButtonProps) {
  return (
    <button
      onClick={onClick}
      className={`rounded-lg border-2 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] text-center w-full focus:outline-none focus:ring-2 focus:ring-[#2B7A78] focus:border-[#2B7A78] ${isSelected
