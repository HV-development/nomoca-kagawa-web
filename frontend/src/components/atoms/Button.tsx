...
export function Button({ children, onClick, type = "button", variant = "primary", className = "", disabled = false }: ButtonProps) {
  ...
  const variantClasses = {
    primary: "bg-green-600 text-white hover:bg-green-700 focus:ring-[#2B7A78]",
    secondary: "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-[#2B7A78]",
    location:
      "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-[#2B7A78]",
  }
