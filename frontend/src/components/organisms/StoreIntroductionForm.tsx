      ...
      <div className="max-w-2xl mx-auto p-4">
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* 店舗2（任意） */}
            <div className="border-2 border-green-200 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-4">店舗 2（任意）</h3>
            ...
            {/* 店舗3（任意） */}
            <div className="border-2 border-green-200 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-4">店舗 3（任意）</h3>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? (isEditMode ? '更新中...' : '登録中...') : (isEditMode ? '変更する' : '登録する')}
              </button>
            </div>
          </form>
        </div>
