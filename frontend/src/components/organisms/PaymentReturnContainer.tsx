...
export function PaymentReturnContainer({
  ...
  if (!isProcessing && campaignInfo) {
    ...
    return (
      <div className="min-h-screen bg-[#FFFEF9] flex items-center justify-center px-4 py-10">
        <div className="bg-white rounded-2xl shadow-[0px_4px_12px_rgba(0,0,0,0.25)] max-w-md w-full p-8 space-y-6">
          <div className="flex justify-center">
            <div className="h-[50px] w-[50px] rounded-full bg-[#3A8A88] flex items-center justify-center">
          ...
          <div className="rounded-lg border border-[rgba(58,138,136,0.24)] bg-[#FFFEF5] px-4 py-6 space-y-4">
            <p className="text-center text-xs font-bold text-[#2B7A78]">
            ...
            <div className="rounded-lg border border-[#d9d9d9] bg-white px-4 py-2">
              <div className="flex items-center justify-between border-b border-[#d9d9d9] py-2">
                ...
                <span className="flex items-center gap-1 text-xs font-bold text-[#2B7A78]">
                  <span>本日</span>
                  <span>〜</span>
          ...
          <button
            ...
            className="w-full rounded-2xl bg-[#3A8A88] py-4 text-sm font-semibold text-white"
          >
            HOME画面へ進む
          </button>
        </div>
