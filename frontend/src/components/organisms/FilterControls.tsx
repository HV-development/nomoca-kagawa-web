    ...
    <div className="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-30">
      ...
      <div className="grid grid-cols-3 gap-1 px-2 py-4">
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-1 px-2 py-2 border rounded-full text-xs font-medium transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#2B7A78] focus:border-[#2B7A78] active:bg-gray-100 ${selectedArea
        ...
        <button
          ...
          className={`w-full flex items-center justify-center gap-1 px-2 py-2 border rounded-full text-xs font-medium transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-[#2B7A78] focus:border-[#2B7A78] active:bg-gray-100 ${selectedGenres.length > 0
            ? "border-green-500 bg-green-50 text-green-700"
            : "border-gray-300 bg-white text-gray-700"
            }`}
        >
